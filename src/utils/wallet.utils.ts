...
const loadWalletV1Data = (cs: Slice) => {
...
const loadWalletV2Data = (cs: Slice) => {
    const seqno = cs.loadUint(32);
    const publicKey = cs.loadBuffer(32);
...
const loadWalletV3Data = (cs: Slice) => {
    const seqno = cs.loadUint(32);
...
const loadWalletV4Data = (cs: Slice) => {
    const seqno = cs.loadUint(32);
    const walletId = cs.loadUint(32);
    const publicKey = cs.loadBuffer(32);
...
const loadWalletV5BetaData = (cs: Slice) => {
...
const loadWalletV5Data = (cs: Slice) => {
    const isSignatureAuthAllowed = cs.loadBoolean();
    const seqno = cs.loadUint(32);
    const walletId = cs.loadUint(32);
    const publicKey = cs.loadBuffer(32);
...
export const parsePublicKey = (stateInit: StateInit) => {
